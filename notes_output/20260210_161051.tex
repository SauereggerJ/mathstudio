...
$x_n \to x$ in $E \Leftrightarrow \forall \epsilon > 0, \exists N \in \mathbb{N} : \|x_n - x\|_{\infty} \leq \epsilon \; \forall n \geq N$ is equivalent to $x_n \in B(a, \epsilon) \; \forall n \geq N$.
