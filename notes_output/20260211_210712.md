...
tags: [linear-algebra, operators, spectral-theory]
---
...
**Proof:** Suppose $V$ is a finite-dimensional complex vector space of dimension $n>0$ and $T \in \mathcal{L}(V)$.
...
**Theorem:** For every $T \in \mathcal{L}(V)$ of a finite dimensional vector space yields a unique monic polynomial $p$ with smallest degree and $p(T)=0$ and $\dim V \ge \text{degree } p$.

**Proof:** Suppose $\dim(V)=n$. We prove the theorem through induction over the dimension of $V$.
...
## Recommended Reading
- **Linear Algebra Done Right** by Sheldon Axler (Match: 0.73)
- **Linear Algebra** by Meckes & Meckes (Match: 0.72)
