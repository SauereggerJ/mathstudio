---
title: Konvexit\"at und Ableitungen
tags: [Analysis, Konvexit\"at, Mittelwertsatz]
---

Sei $f(x)$ eine auf einem gegebenen Intervall $I$ definierte reelle Funktion. Falls $f(x)$ konvex ist gilt $f'(x)$ ist wachsend, entsprechendes f\"ur konkav und fallend.
...
## Recommended Reading
- **Tutorium Analysis 1 und Lineare Algebra 1** by Florian Modler, Martin Kreh (Match: 0.67)
- **Grundkurs Analysis 2** by Klaus Fritzsche (Match: 0.67)
- **Analysis I** by H. Amann (Match: 0.67)
